...
def get_args():
    ...
    parser.add_argument("--image_dir_rain", type=str, default='dataset/test/rain',
                        help="rain image dir")
    parser.add_argument("--image_dir_gt", type=str, default='dataset/test/norain',
                        help="gt image dir")
    parser.add_argument("--model", type=str, default="the_end",
                        help="model architecture ")
    parser.add_argument("--weight_file", type=str, default='./weights/xxxxxxxxxxxx.hdf5',
...
def main():
    ...
    for image_path_rain in image_paths:
        ...
        print(pred[0].shape)
        if if_n:
            denoised_image = get_image(pred[0]*[255])
        else:
