...
def get_args():
    ...
    parser.add_argument("--image_dir_noise", type=str, default='./dataset/train/input',
                        help="train image dir")
    parser.add_argument("--image_dir_original", type=str, default='./dataset/train/label',
                        help="train image dir")
    parser.add_argument("--test_dir_noise", type=str, default='./dataset/test/rain',
                        help="test image dir")
    parser.add_argument("--test_dir_original", type=str, default='./dataset/test/norain',
                        help="test image dir")
    parser.add_argument("--If_n", type=bool, default=True,#False
...
def main():
    ...
    model.compile(optimizer=opt, loss={"subtract_1": "mse"}, loss_weights={'subtract_1': 1}, metrics=[PSNR])
